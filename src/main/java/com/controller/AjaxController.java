...
public class AjaxController extends HttpServlet{
	...
	protected void doAction(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(command.equals("/ajax/hello.ajax")) {
			...
			// get() 방식은 request.getParameter() 받으면 됨
			...
			// out.println("{\"키\":\"값\"}"); 자바에선 JSON 문법 없음 -> JSON 형식의 문자열로 일단 적어야 함
			
			
			
			//JSONObject 또는 GSON 외부 라이브러리
			...
			try {
				...
				String name = (String)object.get("name"); // 키
				long age = (long)object.get("age"); // 키
